...
public class SearchFood extends Application {
	static String sch = "";
	...
	public void start(Stage primaryStage) throws ClassNotFoundException, SQLException {
		...
		hbox1.getChildren().addAll(txtSearch, btnSearch);
		...
		Label itentifier = new Label("Category: ");
		...
		vbox.getChildren().add(itentifier);
			...
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				...
				try {
					...
					while (rs.next()) {
						...
						description.setText("Description: " + rs.getString("description"));
						itentifier.setText("Category: " + rs.getString("identifier"));
		...
		btnSearch.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				primaryStage.hide();
				SearchResultFood dreg = new SearchResultFood();

				try {
					dreg.start(SearchResultFood.classStage);
